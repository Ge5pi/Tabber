...
app.post('/api/analyze-tabs', async (req: Request, res: Response) => {
  const { tabs } = req.body;
...
app.post('/api/check-distraction', async (req: Request, res: Response) => {
...
app.listen(PORT, () => {
  ...
  console.log(`\n🚀 ==================================================`);
  console.log(`🚀 [TabAI Express TS Server] Listening on http://localhost:${PORT}`);
